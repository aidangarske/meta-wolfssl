...
# Set WOLFPROVIDER_REPLACE_DEFAULT = "1" in local.conf to enable replace-default mode
...
PACKAGECONFIG:class-target:pn-openssl = "${@'' if d.getVar('WOLFPROVIDER_REPLACE_DEFAULT') == '1' else 'enable-fips'}"
